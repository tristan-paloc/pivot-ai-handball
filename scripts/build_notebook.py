...
CELLULES = [
    ...
    code(
        ...
        "print(f\"Trackers totaux : {meta['nb_trackers_total']}\")\n"
        "print(f\"Joueurs apres filtre fragments : {meta['nb_joueurs_stats']} \"\n"
        "      f\"(sur {meta['nb_joueurs_avant_filtre']} avant filtre)\")\n"
        "print(f\"Methode homographie : {meta['homographie_methode']}\")\n"
